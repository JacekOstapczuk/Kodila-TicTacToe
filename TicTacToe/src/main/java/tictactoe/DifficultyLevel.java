   ...
   public int allocationDifficultyLevel(int choiceDifficultyLevel, Map gameMap) {
      ...
      if (choiceDifficultyLevel == 1) {
         ...
         if (!(gameMap.containsKey(55))) {
            ...
            for (int a = 0; a <= 99; a++) {
               if (XOlist.get(a).equals("X") && XOlist.get(a + 10).equals("X") && XOlist.get(a + 20).equals("X") && XOlist.get(a + 30).equals("X")) {
                  if (XOlist.get(a + 40).equals("O") && XOlist.get(a - 10).equals("O")) {
                     break;
               ...
               } else if (XOlist.get(a).equals("X") && XOlist.get(a + 1).equals("X") && XOlist.get(a + 2).equals("X") && (XOlist.get(a + 3).equals("X"))) {
                  if (XOlist.get(a + 4).equals("O") && XOlist.get(a - 1).equals("O")) {
                     break;
                  } else if (XOlist.get(a + 4).equals("O")) {
                     numberToPlay = a - 1;
                  } else {
                     numberToPlay = a + 4;
                  }
               } else if (XOlist.get(a).equals("X") && XOlist.get(a + 11).equals("X") && XOlist.get(a + 22).equals("X") && (XOlist.get(a + 33).equals("X"))) {
                  if (XOlist.get(a + 44).equals("O") && XOlist.get(a - 11).equals("O")) {
                     break;
                  } else if (XOlist.get(a + 44).equals("O")) {
                     numberToPlay = a - 11;
                  } else {
                     numberToPlay = a + 44;
                  }
               } else if (XOlist.get(a).equals("X") && XOlist.get(a + 9).equals("X") && XOlist.get(a + 18).equals("X") && (XOlist.get(a + 27).equals("O"))) {
                  if (XOlist.get(a + 36).equals("O") && XOlist.get(a - 9).equals("O")) {
                     break;
                  } else if (XOlist.get(a + 36).equals("O")) {
                     numberToPlay = a - 9;
                  } else {
                     numberToPlay = a + 36;
                  }
               } else if (XOlist.get(a).equals("X") && XOlist.get(a + 10).equals("X") && XOlist.get(a + 20).equals("X")) {
               ...
               if (XOlist.get(numberToPlay) == "X" || XOlist.get(numberToPlay) == "O") {
                  numberToPlay = randomGenerator.nextInt(100);
               }
            }
         }
